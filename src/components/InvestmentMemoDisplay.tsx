  ...
  return (
    <div className="space-y-6">
      ...
      {parsed.executiveSummary && (
        <Card className={
          parsed.executiveSummary.decision === 'GO' ? 'border-primary/50' :
          parsed.executiveSummary.decision === 'NO-GO' ? 'border-destructive/50' :
          parsed.executiveSummary.decision === 'CONDITIONAL' ? 'border-secondary/50' :
          ''
        }>
          <CardHeader>
      ...
      {parsed.recommendation && parsed.recommendation.decision && (
        <Card className={
          parsed.recommendation.decision === 'GO' ? 'border-primary bg-primary/5' :
          parsed.recommendation.decision === 'NO-GO' ? 'border-destructive bg-destructive/5' :
